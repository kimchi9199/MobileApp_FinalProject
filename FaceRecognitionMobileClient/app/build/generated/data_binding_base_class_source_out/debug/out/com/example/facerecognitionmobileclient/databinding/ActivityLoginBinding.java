...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull TextView forgotPassword,
      @NonNull ImageView googleBtn, @NonNull Button loginButton, @NonNull EditText loginEmail,
      @NonNull EditText loginPassword, @NonNull TextView loginText,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, forgotPassword, googleBtn,
